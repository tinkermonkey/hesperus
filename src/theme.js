  ...
  badge: {
    root: {
      ...
      color: {
        ...
        warning: "border-retro-warning bg-retro-bg text-retro-warning-text dark:border-retro-warning dark:bg-retro-bg dark:text-retro-warning",
  ...
  tabs: {
    ...
    tablist: {
      ...
      tabitem: {
        ...
        variant: {
          default: {
            base: "px-5 h-9 border-r-2 border-retro-fg last:border-r-0 dark:border-retro-fg",
            active: {
          ...
          underline: {
            base: "px-4 h-9 border-b-[3px] mb-[-2px] border-transparent",
            active: {
